...
const BulkTshirt = () => (
  <>
    <Helmet>
      <title>Bulk T-shirt Printing | Trendydice</title>
      <meta
        name="description"
        content="Bulk T-shirt printing and customization by Trendydice. High-quality, affordable, and fast delivery for corporate, events, and more."
      />
      <meta
        name="keywords"
        content="bulk t-shirt, t-shirt printing, custom t-shirts, Trendydice, corporate t-shirts, event apparel"
      />
    </Helmet>
    <div className="min-h-screen bg-[#FFF4DF] flex flex-col items-center px-2 sm:px-0">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 sm:gap-10 w-full max-w-5xl px-2 sm:px-0">
          ...
          <div className="flex-1 text-left w-full">
            ...
            <p className="mb-3 sm:mb-4 text-gray-800 text-sm sm:text-base">
              Indulge in the ultimate comfort and style with our oversize
              T-shirts crafted from 200GSM, 220GSM, and 240GSM cotton.
              Experience the luxurious feel of bio-washed softness, elevating
              these shirts to a premium quality level. Whether embracing a
              laid-back vibe or making a bold fashion statement, our oversize
              tees offer the perfect blend of comfort and trendiness. Unleash
              your individuality with these versatile and unisex wardrobe
              essentials.
              <br />
              <br />
              ...
              t shirt printing customised t shirt dtf printing bulk t-shirt
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-6 sm:gap-10 w-full max-w-5xl mt-10 sm:mt-16 px-2 sm:px-0">
        <div className="flex-1 text-left w-full">
          ...
          <p className="mb-3 sm:mb-4 text-gray-800 text-sm sm:text-base">
            Men's round neck T-shirts epitomize casual comfort with their
            classic design, offering versatility for various occasions. Crafted
            from premium cotton and available in 160GSM, 180GSM, and 200GSM,
            they provide a soft and breathable feel. Whether worn solo or
            layered, these wardrobe essentials cater to timeless style. Embrace
            the simplicity of the round neck silhouette, making these T-shirts a
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-6 sm:gap-10 w-full max-w-5xl mt-10 sm:mt-16 px-2 sm:px-0">
        <div className="flex-1 text-left w-full">
          ...
          <p className="mb-3 sm:mb-4 text-gray-800 text-sm sm:text-base">
            ...
            to your wardrobe. Elevate your casual style with the perfect blend
            of comfort and premium quality in our Polo T-shirts.
            <br />
            <br />
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 sm:gap-10 w-full max-w-5xl mt-14 sm:mt-20 px-2 sm:px-0">
        <div className="flex-1 text-left w-full order-2 md:order-1">
          ...
          <p className="mb-3 sm:mb-4 text-gray-800 text-sm sm:text-base">
            ...
            comfort and fashion effortlessly with our heavyweight and cozy
            hoodie collection.
            <br />
            <br />
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 sm:gap-10 w-full max-w-5xl mt-14 sm:mt-20 px-2 sm:px-0">
        ...
        <div className="flex-1 text-left w-full order-2 md:order-2">
          ...
          <p className="mb-3 sm:mb-4 text-gray-800 text-sm sm:text-base">
            Get ready for summer vibes with our soft and comfy women's full
            sleeve crop top. It's made from 100% bio-wash cotton, ensuring a
            cozy feel. Stay cool and stylish on sunny days with this trendy top
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 sm:gap-10 w-full max-w-5xl mt-14 sm:mt-20 mb-14 sm:mb-20 px-2 sm:px-0">
        ...
        <div className="flex-1 text-left w-full order-2 md:order-2">
          ...
          <p className="mb-3 sm:mb-4 text-gray-800 text-sm sm:text-base">
            Get summer-ready in our round-neck women's t-shirt, crafted from
            100% bio-wash soft cotton. Embrace the season with this comfortable
            and breathable tee, perfect for warm days. Stay effortlessly cool
            and stylish with the classic round-neck design, ideal for a
            laid-back summer look.
            <br />
            <br />
            <span className="font-bold text-black">STARTING PRICE: 145₹</span> t
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 sm:gap-10 w-full max-w-5xl mt-14 sm:mt-20 mb-14 sm:mb-20 px-2 sm:px-0">
        <div className="flex-1 text-left w-full order-2 md:order-1">
          ...
          <p className="mb-3 sm:mb-4 text-gray-800 text-sm sm:text-base">
            ...
            crafted with attention to detail. Made from 100% bio-wash soft
            cotton, this tee combines comfort with a touch of sophistication.
            Embrace the fashion-forward look of the round-neck design, perfect
            for a trendy and casual vibe.
            <br />
            <br />
            <span className="font-bold text-black">STARTING PRICE: 205₹</span> t
            shirt printing customised t shirt dtf printing
