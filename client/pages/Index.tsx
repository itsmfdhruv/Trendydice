          ...
          <div className="space-y-8">
            <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
              ...
              <p className="text-black font-poppins text-base sm:text-lg">
                Trendydice has no Minimum Order Quantity. You can customise and
                order Single-piece T-shirts, Hoodies, Polo T-shirts, Mugs, and
                other customisable products.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
              <h3 className="text-[#211278] font-poppins text-lg sm:text-xl font-semibold mb-2">
            ...
            <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
              ...
              <p className="text-black font-poppins text-base sm:text-lg">
                ...
                <br />
                For Plain same-day dispatch is available and customised products
                may take 2 to 7 working days depending on the order quantity,
                Product colour and print design.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
              <h3 className="text-[#211278] font-poppins text-lg sm:text-xl font-semibold mb-2">
