...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Home | Trendydice</title>
        <meta
          name="description"
          content="Trendydice: Your B2B print-on-demand and dropshipping partner for custom apparel, trophies, and more. Empowering businesses since 2016."
        />
        <meta
          name="keywords"
          content="custom t-shirts, print on demand, B2B, Trendydice, trophies, apparel, bulk orders, event merchandise"
        />
      </Helmet>
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
                <h3 className="text-[#211278] font-poppins text-lg sm:text-xl font-semibold mb-2">
                  Is there a minimum quantity required for a custom product?
                </h3>
                <p className="text-black font-poppins text-base sm:text-lg">
                  Trendydice has no Minimum Order Quantity. You can customise
                  and order Single-piece T-shirts, Hoodies, Polo T-shirts, Mugs,
                  and other customisable products.
                </p>
              </div>
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
                <h3 className="text-[#211278] font-poppins text-lg sm:text-xl font-semibold mb-2">
                  Can I get any bulk order discount if I place a bulk order?
                </h3>
                <p className="text-black font-poppins text-base sm:text-lg">
                  If you order anything above 15 pcs the Trendydice gives you an
                  extra discount, You can also get in touch with us at <br />
                  Email Id: info@trendydice.com
                  <br />
                  Mob: 97380-97381
                </p>
              </div>
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
                ...
                <p className="text-black font-poppins text-base sm:text-lg">
                  ...
                  <br />
                  Plain (without printing)
                  <br />
                  Customized (With printing)
                  <br />
                  For Plain same-day dispatch is available and customised
                  products may take 2 to 7 working days depending on the order
                  quantity, Product colour and print design.
                </p>
              </div>
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
                <h3 className="text-[#211278] font-poppins text-lg sm:text-xl font-semibold mb-2">
                ...
                <p className="text-black font-poppins text-base sm:text-lg">
                  We give you the following payment options: Credit Card, Debit
              ...
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
                ...
                <p className="text-black font-poppins text-base sm:text-lg">
                  You can call or WhatsApp us at <br />
                  Email: info@trendydice.com
                  <br />
                  Mob: 97380-97381
                </p>
              </div>
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
                ...
                <p className="text-black font-poppins text-base sm:text-lg">
                  We ensure all our products are thoroughly checked before being
                  sent out. But if due to any unforeseen circumstances the
                  products have any defect, we will replace them.
                </p>
              </div>
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
                <h3 className="text-[#211278] font-poppins text-lg sm:text-xl font-semibold mb-2">
                ...
                <p className="text-black font-poppins text-base sm:text-lg">
                  You can order through Call, Message, or Email.
                </p>
              </div>
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
                <h3 className="text-[#211278] font-poppins text-lg sm:text-xl font-semibold mb-2">
                  How do I order Bulk Plain products?
                </h3>
                <p className="text-black font-poppins text-base sm:text-lg">
              ...
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
                <h3 className="text-[#211278] font-poppins text-lg sm:text-xl font-semibold mb-2">
                  How do I check the serviceable area?
                </h3>
                <p className="text-black font-poppins text-base sm:text-lg">
              ...
              <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.07)] p-6">
                <h3 className="text-[#211278] font-poppins text-lg sm:text-xl font-semibold mb-2">
                  Which type of printing is provided?
                </h3>
                <p className="text-black font-poppins text-base sm:text-lg">
                  DTF Printing.
                  <br />
