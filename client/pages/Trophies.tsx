...
const Trophies = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Trophies & Momento | Trendydice</title>
        <meta
          name="description"
          content="Shop for custom trophies and momentos at Trendydice. Perfect for events, awards, and recognition. High-quality and customizable."
        />
        <meta
          name="keywords"
          content="trophies, momentos, custom awards, Trendydice, event trophies, recognition awards"
        />
      </Helmet>
