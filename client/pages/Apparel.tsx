...
const Apparel = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Custom Apparel | Trendydice</title>
        <meta
          name="description"
          content="Explore Trendydice's range of custom apparel: t-shirts, hoodies, jackets, and more. High-quality, personalized for your brand or event."
        />
        <meta
          name="keywords"
          content="custom apparel, t-shirts, hoodies, jackets, Trendydice, event merchandise, personalized clothing"
        />
      </Helmet>
